...
func (in *QdrantClusterRoutingStatus) DeepCopyInto(out *QdrantClusterRoutingStatus) {
	*out = *in
	...
	if in.MultiAZRoutingPhaseEnteredAt != nil {
		in, out := &in.MultiAZRoutingPhaseEnteredAt, &out.MultiAZRoutingPhaseEnteredAt
		*out = (*in).DeepCopy()
	}
	if in.MultiAZDNSGateClearedAt != nil {
		in, out := &in.MultiAZDNSGateClearedAt, &out.MultiAZDNSGateClearedAt
		*out = (*in).DeepCopy()
	}
}
