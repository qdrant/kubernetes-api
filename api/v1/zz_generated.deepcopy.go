...
func (in *QdrantCloudRegionStatus) DeepCopyInto(out *QdrantCloudRegionStatus) {
	*out = *in
	...
	if in.VolumeAttributeClasses != nil {
		in, out := &in.VolumeAttributeClasses, &out.VolumeAttributeClasses
		*out = make([]VolumeAttributeClass, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VolumeAttributeClass) DeepCopyInto(out *VolumeAttributeClass) {
	*out = *in
	if in.Parameters != nil {
		in, out := &in.Parameters, &out.Parameters
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VolumeAttributeClass.
func (in *VolumeAttributeClass) DeepCopy() *VolumeAttributeClass {
	if in == nil {
		return nil
	}
	out := new(VolumeAttributeClass)
	in.DeepCopyInto(out)
	return out
}
